...
app.get('/api/hello2', function (req, res) {
    const helloResponse = {"greeting":"Bundle3a /api/hello2 response", "timestamp":Date.now()};
    res.status(200).json(helloResponse);
});

//Hello World API
app.get('/api/hello', function (req, res) {
    const helloResponse = {"greeting":"Bundle3a /api/hello response", "timestamp":Date.now()};
    res.status(200).json(helloResponse);
});
